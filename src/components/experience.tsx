...
const Experience = () => {
  ...
  return (
    <section id="experience-section" ref={ref} className={`p-10 lg:p-20 lg:px-32 lg:min-h-screen transition-opacity duration-800 ease-in-out ${showContent ? "opacity-100" : "opacity-0"}`}>
